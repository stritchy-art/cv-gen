...
class TestConversionRequest:
    ...
    def test_conversion_request_defaults(self):
        ...
        request = ConversionRequest(filename="test.pdf", content=b"fake pdf content")
    ...
    def test_conversion_request_full(self):
        ...
        request = ConversionRequest(
            filename="cv_test.pdf", content=b"fake pdf content with more data"
        )
    ...
    def test_conversion_request_different_files(self):
        ...
        for filename in filenames:
            request = ConversionRequest(filename=filename, content=b"test content")
...
class TestConversionResponse:
    ...
    def test_conversion_response_minimal(self):
        ...
        response = ConversionResponse(success=True, filename="cv_converted.docx")
    ...
    def test_conversion_response_error(self):
        ...
        response = ConversionResponse(
            success=False, filename="", error="Erreur lors de l'extraction PDF"
        )
    ...
    def test_conversion_response_json(self):
        ...
        response = ConversionResponse(success=True, filename="test.docx")
        ...
        assert (
            '"filename":"test.docx"' in json_str
            or '"filename": "test.docx"' in json_str
        )
