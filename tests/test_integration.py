...
class TestEndToEndWorkflow:
    ...
    def test_complete_cv_generation_french(self, sample_cv_data):
        ...
        try:
            result = generate_docx_from_cv_data(
                cv_data=sample_cv_data, output_path=output_path, target_language="fr"
            )
    ...
    def test_complete_cv_generation_english(self, sample_cv_data):
        ...
        try:
            result = generate_docx_from_cv_data(
                cv_data=sample_cv_data, output_path=output_path, target_language="en"
            )
...
class TestSettingsIntegration:
    ...
    def test_all_directories_created(self):
        ...
        directories = [settings.CACHE_DIR, settings.LOGS_DIR, settings.UPLOAD_DIR]
