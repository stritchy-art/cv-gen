...
def render_processing_options() -> Tuple[bool, str, Optional[any], Optional[str], Optional[int]]:
    """
    ...
    return generate_pitch, improvement_mode, job_offer_file, candidate_name.strip() if candidate_name else None, max_pages
